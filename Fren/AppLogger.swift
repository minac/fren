...
/// Structured logger that writes to both OSLog and a JSONL file.
/// OSLog for system tools (Console.app, Instruments), JSONL for Claude.
public final class AppLogger: Sendable {
    ...
    public init(subsystem: String = Bundle.main.bundleIdentifier ?? "com.fren.app", category: String = "default") {
